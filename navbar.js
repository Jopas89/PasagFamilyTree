...
// Open/hide home modal (toggle on link click)
homeLink.addEventListener("click", (e) => {
  e.preventDefault();
  if (homeModal.style.display === "block") {
    homeModal.style.display = "none"; // hide if already open
  } else {
    homeModal.style.display = "block"; // show if hidden
  }
});
